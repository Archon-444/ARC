...
Launch a coin, share the link, trade the bonding curve. NFT studio, listings, and auctions stay in the repo as a library — they are not the product. Canonical direction: [PRODUCT.md](./PRODUCT.md). Old OpenSea/shell docs: [archive/unconstant-product/](./archive/unconstant-product/). Agent-commerce experiment: [AgentTrust](https://github.com/Archon-444/AgentTrust) ([archive/agent-trust/](./archive/agent-trust/)).
