...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* ======================== HERO SECTION ======================== */}
      <section className="relative overflow-hidden py-20 dark:bg-background-dark">
      ...
      <div className="container-custom space-y-12 py-16">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          {/* NFT Marketplace */}
          <div className="relative group rounded-3xl p-8 overflow-hidden bg-[#0f3460] border border-blue-500/20 hover:border-blue-400/50 transition-all duration-300">
          ...
          {/* Token Launchpad */}
          <div className="relative group rounded-3xl p-8 overflow-hidden bg-[#2e1065] border border-purple-500/20 hover:border-purple-400/50 transition-all duration-300">
