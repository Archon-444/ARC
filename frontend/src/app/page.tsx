...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* ======================== HERO SECTION ======================== */}
      <section className="relative overflow-hidden py-20 bg-white/20 dark:bg-slate-900/30 backdrop-blur-md border-b border-gray-200/50 dark:border-white/5">
        <div className="container-custom grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Left 8 cols — Featured Drop */}
          <div className="lg:col-span-8 relative overflow-hidden rounded-3xl bg-white/60 dark:bg-surface-dark backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-xl group min-h-[400px]">
            ...
            <div className="relative z-10 p-8 md:p-12 flex flex-col justify-center h-full">
              {/* Featured Drop badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 dark:bg-white/10 border border-black/10 dark:border-white/10 w-fit mb-6">
                <Star className="h-3 w-3 text-yellow-500 dark:text-yellow-400" />
                <span className="text-xs font-semibold tracking-wide uppercase text-gray-900 dark:text-white/90">Featured Drop</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4 leading-tight tracking-tight">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-primary-500 to-purple-600 dark:from-blue-400 dark:via-primary-400 dark:to-purple-400">
          ...
          <div className="lg:col-span-4">
            <div className="bg-white/60 dark:bg-surface-dark backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-6 h-full shadow-xl">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                Live Stats
                <span className="px-2 py-0.5 rounded text-[10px] bg-red-100 text-red-600 dark:bg-red-500/20 dark:text-red-400 border border-red-200 dark:border-red-500/30 uppercase tracking-wide font-semibold">Real-time</span>
              </h3>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { name: 'Ape Club #102', label: 'New offer', price: '12.5 ETH', sub: '+5% floor', subColor: 'text-green-600 dark:text-green-400' },
                ].map((item) => (
                  <div key={item.name} className="group/item p-4 rounded-2xl bg-white/40 dark:bg-background-dark/50 border border-white/60 dark:border-white/5 hover:border-gray-300 dark:hover:border-gray-600 transition-all cursor-pointer">
              ...
              {/* Volume mini-chart */}
              <div className="relative h-32 w-full mt-4 bg-gradient-to-b from-transparent to-primary-500/5 rounded-xl border border-gray-200/50 dark:border-white/5 overflow-hidden">
                ...
                <div className="absolute top-2 left-4 text-xs font-mono text-gray-500 dark:text-gray-400">Volume (24h)</div>
              ...
              {stats && (
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <div className="p-3 rounded-xl bg-white/40 dark:bg-background-dark/50 border border-white/60 dark:border-white/5">
      ...
      <div className="container-custom space-y-12 py-16">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          {/* NFT Marketplace */}
          <div className="relative group rounded-3xl p-8 overflow-hidden bg-blue-600/10 dark:bg-blue-900/30 backdrop-blur-lg border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
            ...
            <div className="absolute -right-10 -top-10 opacity-10 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-500">
              <Store size={160} />
            </div>
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">NFT Marketplace</h2>
              <p className="text-gray-700 dark:text-blue-100/80 mb-8 max-w-sm text-lg">
                Trade unique digital assets, explore curated collections, and bid on live auctions.
              </p>
              <Link href="/explore" className="inline-flex items-center gap-2 font-semibold text-blue-700 dark:text-white hover:text-blue-800 dark:hover:text-blue-200 transition-colors">
          ...
          {/* Token Launchpad */}
          <div className="relative group rounded-3xl p-8 overflow-hidden bg-purple-600/10 dark:bg-purple-900/30 backdrop-blur-lg border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
            ...
            <div className="absolute -right-10 -top-10 opacity-10 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-500">
              <Rocket size={160} />
            </div>
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Token Launchpad</h2>
              <p className="text-gray-700 dark:text-purple-100/80 mb-8 max-w-md text-lg">
                Launch an ERC-20 token with a bonding curve. Graduate at 80% to unlock creator treasury.
              </p>
              <Link href="/launch" className="inline-flex items-center gap-2 font-semibold text-purple-700 dark:text-white hover:text-purple-800 dark:hover:text-purple-200 transition-colors">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-12">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-500/20 text-xs font-semibold">
              ...
              {notableDrops.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {notableDrops.slice(0, 4).map((listing, i) => (
                    <div key={listing.id} className="group relative rounded-2xl bg-white/60 dark:bg-surface-dark backdrop-blur-xl border border-white/50 dark:border-white/10 overflow-hidden hover:border-primary-500/50 transition-all duration-300 shadow-sm">
                      <div className="h-48 bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center">
                          {i % 2 === 0
                            ? <Diamond className="h-16 w-16 text-gray-300 dark:text-gray-600 group-hover:scale-110 transition-transform duration-500" />
                            : <Palette className="h-16 w-16 text-gray-300 dark:text-gray-600 group-hover:scale-110 transition-transform duration-500" />
                          }
                        </div>
                      ...
                      <div className="p-5">
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1 group-hover:text-primary-500 dark:group-hover:text-primary-400 transition-colors">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <button className="px-4 py-1.5 rounded-lg bg-gray-900 dark:bg-gray-700 hover:bg-primary-500 dark:hover:bg-white dark:hover:text-black text-white text-sm font-medium transition-colors">
                            Bid
                          </button>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[0, 1].map((i) => (
                    <div key={i} className="rounded-2xl bg-white/60 dark:bg-surface-dark border border-white/50 dark:border-white/10 overflow-hidden">
                ...
                <div className="rounded-2xl border border-gray-200 dark:border-white/5 bg-white/60 dark:bg-surface-dark backdrop-blur-lg p-8 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {CATEGORY_DATA.map((cat) => (
                  <Link
                    key={cat.label}
                    href={cat.href}
                    className="group p-4 bg-white/60 dark:bg-surface-dark backdrop-blur-lg border border-white/50 dark:border-white/10 rounded-2xl hover:border-primary-500/50 hover:bg-white/80 dark:hover:bg-gray-800/80 transition-all card-hover shadow-sm"
                  >
          ...
          <div className="lg:col-span-4">
            <div className="bg-white/60 dark:bg-surface-dark backdrop-blur-xl rounded-3xl p-6 border border-white/50 dark:border-white/10 h-full shadow-lg">
              <div className="flex items-center justify-between mb-6">
                <div>
                ...
                {(['all', 'sales', 'listings'] as const).map((f) => (
                  <button
                    ...
                    className={activityFilter === f
                      ? 'px-3 py-1 rounded-full bg-gray-900 dark:bg-white text-white dark:text-black text-xs font-bold shadow-sm'
                      : 'px-3 py-1 rounded-full bg-white/50 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-xs font-medium border border-gray-200 dark:border-gray-700 transition-colors'
                    }
                  >
              ...
              {filteredActivity.length > 0 ? (
                <div className="space-y-3 max-h-[400px] overflow-y-auto scrollbar-thin pr-2">
                  {filteredActivity.map((event, index) => (
                    <div key={`${event.name}-${index}`} className="p-3 rounded-xl bg-white/50 dark:bg-background-dark/50 border border-white/60 dark:border-white/5 hover:border-gray-300 dark:hover:border-gray-600 transition-all">
                ...
                <div className="bg-white/50 dark:bg-background-dark/50 rounded-xl border border-white/60 dark:border-white/5 p-4 h-64 flex flex-col justify-center items-center text-center">
