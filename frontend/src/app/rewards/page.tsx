        ...
        <div className="mt-8">
          {activeTab === 'overview' && (
            <div className="grid gap-6 lg:grid-cols-2">
              {/* XP Rewards Info */}
              <div className="rounded-xl border border-neutral-200/60 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/50">
                ...
                <div className="mt-4 space-y-3">
                  {Object.entries(XP_REWARDS).map(([action, xp]) => (
                    <div
                      key={action}
                      className="flex items-center justify-between rounded-lg bg-white/40 p-3 dark:bg-white/5"
                    >
              ...
              {/* Recent Badges */}
              <div className="rounded-xl border border-neutral-200/60 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/50 lg:col-span-2">
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  {mockUserData.badges.map((badgeId) => {
                    ...
                    return (
                      <div
                        key={badgeId}
                        className="flex items-center gap-3 rounded-xl bg-white/40 p-3 dark:bg-white/5"
                      >
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isUnlocked
                        ? 'border-primary-200/60 bg-white/60 backdrop-blur-md dark:border-primary-800/40 dark:bg-slate-900/50'
                        : 'border-neutral-200/60 bg-white/40 opacity-60 backdrop-blur-sm dark:border-white/5 dark:bg-white/5'
                    )}
                  >
                    {!isUnlocked && (
              ...
              {QUESTS.map((quest) => (
                <div
                  ...
                  className={cn(
                    ...
                    quest.completed
                      ? 'border-green-200/60 bg-green-50/60 backdrop-blur-md dark:border-green-800/40 dark:bg-green-900/20'
                      : 'border-neutral-200/60 bg-white/60 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/50'
                  )}
                >
                  <div className="flex items-center justify-between">
