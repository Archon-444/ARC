      ...
      <div className="mx-auto max-w-7xl px-4 py-8 lg:px-6">
            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
                timeRange === range
                  ...
                  : 'bg-white/60 text-neutral-600 hover:bg-white/80 dark:bg-white/10 dark:text-neutral-300 dark:hover:bg-white/20 backdrop-blur-sm'
              }`}
            >
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-neutral-200/60 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/50">
            ...
            <div className="flex h-48 items-center justify-center rounded-lg bg-white/40 dark:bg-white/5">
        ...
        <div className="mt-8 rounded-xl border border-neutral-200/60 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/50">
          <div className="mb-4 flex items-center justify-between">
...
function StatCard({
  ...
  return (
    <div className="rounded-xl border border-neutral-200/60 bg-white/60 p-5 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/50">
