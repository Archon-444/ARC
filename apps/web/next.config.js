        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cloudflare-ipfs.com https://walletconnect.com https://avatars.githubusercontent.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "img-src 'self' data: https: blob:",
              "font-src 'self' data: https://fonts.gstatic.com",
              "connect-src 'self' https://rpc.testnet.arc.network wss://rpc.testnet.arc.network https://api.circle.com https://relay.walletconnect.com wss://relay.walletconnect.com https://ipfs.io https://gateway.pinata.cloud https://cloudflare-ipfs.com",
